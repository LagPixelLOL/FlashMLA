...
def test_flash_mla(b, s_q, mean_sk, h_q, h_kv, d, dv, causal, varlen):
    ...
    block_size = 32  # Use 32 for sm89 (same as sm80)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dtype",
        type=str,
        choices=["bf16"],  # Only bf16 is supported for sm89
        default="bf16",
        help="Data type to use for testing (only bf16 is supported for sm89)",
    )
